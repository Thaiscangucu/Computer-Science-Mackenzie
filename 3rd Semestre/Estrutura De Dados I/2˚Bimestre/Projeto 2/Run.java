...
public class Run {
  ...
  private Node runLinha(String linha) {
    ...
    // Instrução INC
      ...
      if(partes.length == 3){
        if(Character.isDigit(param1)){
          System.out.println("Erro. Linha inválida: " + linha + "\nO parâmetro deve ser um registrador.\n");
        }
    ...
    // Instrução ADD
      ...
      if(partes.length == 4){
        String param2 = partes[3];
        if(Character.isDigit(param1)){ 
          System.out.println("Erro. Linha inválida: " + linha + "\nO primeiro parâmetro deve ser um registrador.\n");
        }
        // Verifica se o segundo parâmetro é um número ou um outro registrador.
        else{
        ...
        System.out.println("Erro na linha '" + linha + "'. Linha inválida!\n");
      }
      return null;
    }
    ...
    // Instrução JNZ
      ...
      if(partes.length == 4){
        ...
        System.out.println("Erro: Instrução '" + instrucao + "' desconhecida \n");   
      }
    }
    return null;
  }
